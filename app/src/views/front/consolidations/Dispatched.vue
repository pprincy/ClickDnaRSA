        ...
        <v-row class="mt-0">
          ...
          >
            <v-toolbar-title class="pl-4 text-h6"
              >Dispatch Cargo</v-toolbar-title
            >
            <p class="pl-4">
              There are two confirmaions, First once the cargo has left the
              facility. Second once the flight has departure. In case of flight
              change, Please change the details by clicking on the edit button.
              If you need to edit the consolidations, move it back to the
              staging screen by clicking on the back arrow.
            </p>
          </v-col>
          ...
          <v-col class="d-flex align-center justify-end pt-0" cols="12" md="5">
            <v-btn
              color="success"
              dark
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-icon
              ...
              v-bind="attrs"
              v-on="on"
              @click="pushToStaging(item)"
            >
              mdi-keyboard-backspace
            </v-icon>
          </template>
          <span>Move Back To Staging</span>
        </v-tooltip>
      </template>
    </v-data-table>
    <CountryPopup
...
import Summary from "@/components/front/consolidations/Summary";
